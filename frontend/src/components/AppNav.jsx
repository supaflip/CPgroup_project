...
function AppNav({ loggedin }) {
  ...
  const authLinks = () => (
    <Fragment>
      <li className="nav-item active">
        <Nav.Link className="ex2" href="/workouts/">
          Workouts
        </Nav.Link>
      </li>
      <br></br>
      <li className="nav-item active">
        <Nav.Link className="ex2" href="/myprofile/">
          My Profile
        </Nav.Link>
      </li>
      <br></br>
      <li className="nav-item active">
        <Nav.Link className="ex2" href="/profile/">
          See All Profiles
        </Nav.Link>
      </li>
      <br></br>
      <li className="nav-item active">
        <Nav.Link className="ex2" href="https://blog.nasm.org/">
          NASM Fitness Blog
        </Nav.Link>
      </li>
      <br></br>
      <li className="nav-item active">
        <Nav.Link className="ex2" onClick={handleSignout} text="signout">
          Signout
        </Nav.Link>
      </li>
    </Fragment>
