...
function HomePage({ USER_AUTH }) {
  ...
  return (
    <div>
      ...
      <Button className="mt-3" variant="secondary" onClick={handleOpenDeleteModal}>Delete</Button>
      {showDeleteModal && <DeleteModal data={weeks} onClose={handleCloseDeleteModal} />}
      <Routes>
        <Route
          path="/"
          element={
